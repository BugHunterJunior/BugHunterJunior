...
### 🔑 [Python Keylogger](https://github.com/BugHunterJunior)
Educational keylogger developed for security research and penetration testing purposes with JSON-based logging mechanism.  
**Technologies:** `OS Libraries` • `JSON` • `pynput` 

### 🔐 [Text Encryption Tool](https://github.com/BugHunterJunior)
Command-line encryption utility implementing cryptographic algorithms for secure text encoding and decoding.  
**Technologies:** `Fernet` • `Cryptography` • `AES`

### 💬 [Secure Chat Application](https://github.com/BugHunterJunior) *(In Progress...)*
Real-time encrypted messaging application featuring end-to-end encryption protocols.  
**Technologies:** `Python` • `Socket Programming` • `RSA/AES Encryption`

### ✅ [Flask Todo Application](https://github.com/BugHunterJunior)
Full-stack web application with CRUD operations for task management and user authentication.  
**Technologies:** `Flask` • `SQLite` • `HTML/CSS` • `JavaScript`

---

### 🎯 Current Mission
* **Web Exploitation** * **Privilege Escalation** * **Advanced Networking**
